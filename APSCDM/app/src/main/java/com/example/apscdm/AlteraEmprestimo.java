...
public class AlteraEmprestimo extends AppCompatActivity {
    EditText cliente;
    EditText livro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_altera_emprestimo);
        ...
        alterar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                crud.alteraRegistroEmprestimo(Integer.parseInt(codigo), cliente.getText().toString(),
                        livro.getText().toString(), categoriaLivro.getText().toString(),
                        dataInicial.getText().toString(), dataFinal.getText().toString(),
                        Integer.parseInt(status.getText().toString()));
                Intent intent = new Intent(AlteraEmprestimo.this, ConsultaDadosEmprestimoAlterar.class);
