...
public class DeletaLivro extends AppCompatActivity {
    EditText isbn;
    EditText titulo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deleta_livro);
        ...
        deletar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                crud.deletaRegistroLivro(Integer.parseInt(codigo));
                Intent intent = new Intent(DeletaLivro.this, ConsultaDadosLivroDeletar.class);
